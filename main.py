...
print(ta.getPriorProbability('NoPlay'))
print(ta.getDocumentProbabilityGivenClass(['Sunny'], 'No Play'))
print(ta.getDocumentProbabilityGivenClass(['Rain', 'Mild', 'Strong', 'hello'], 'Play'))
print(ta.getClassProbabilityGivenDocument(['Rain', 'Hot', 'High', 'Weak'], 'Play'))
